...
public class Mapper extends GraphicsProgram {
    ...
    public void addFirstCircle(double target_x, double target_y, Beacon b2){    
    ...
    public void addSecondCircle(double target_x, double target_y, Beacon b1){
   ...
   public void addThirdCircle(double target_x, double target_y, Beacon b0){
