...
public class main_method {
  ...
  public static double x = 30, y = 170;



  public static int map_length = 5000;  
  public static int map_width = 5000; 
  public static Beacon b0 = new Beacon(0, 450, 485); 
  public static Beacon b1 = new Beacon(1, 435, 10); 
  public static Beacon b2 = new Beacon(2, 50, 10); 
  public static Beacon[] beacons = {b0, b1, b2}; 
  public static Mapper map = new Mapper(map_length, map_width, x, y, beacons[0], beacons[1], beacons[2]);
  ...
  public double[] triangulate(double x0, double y0, double r0, double x1, double y1, double r1, double x2, double y2, double r2) {
    ...
    if(d > r0 + r1) {
      ...
      */
        public static void set_radii(double x, double y){
